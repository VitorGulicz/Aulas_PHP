...
<body>
    ...
    echo "ORIGINAL: ";
    print_r ($estados);
    echo "<hr>STRTOLOWER: Converte as strings para minusculas<br>";
    for ($i = 0; $i < count($estados); $i++){
        $estados[$i] = strtolower($estados[$i]);
    }
    echo "STRTOLOWER: "; print_r($estados);
    echo "<hr>SHIFT : Retira primeiro elemento de um array<br>";
    ...
    echo "REVERSE: ";print_r($estados);
    echo "<hr>SORT :Ordena a ordem de um array<br>";
    sort($estados);
